...
public class SearchingAndSortingAlgorithms {
	/* Create a method that will return the first index of a broken egg */
	@Test
...
//*
	...
	public void testFindMaxiumum() throws Exception {
		...
		assertEquals(6.6, Algorithms.findTallest(peeps), 0.01);
	}
	...
	/*
	 * The Morse code for SOS is "... --- ...". Create a method that can tell if SOS is contained in a message.
	 */
	@Test
	...
	/*
	 * Sort the words in alphabetical order. Your teacher may need to explain compareTo.
	 */
	@Test
